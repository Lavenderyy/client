...
<div class="wrapper">
	<div class="container" id="divmsg">
		<h1>欢迎来到chicken of mom</h1>
		<form class="form" action="login" onsubmit="return validate_form(this)" method="post">
			<input type="text" placeholder="用户名" id="username" name="username">
			<input type="password" placeholder="密码" id="userpass" name="password">
			<input type="hidden" value=${fail } id="fail1">
			<input type="submit" id="login-button" value="用户登录"></input>
			<p>注册</p>
		</form>
	</div>
...
if(document.getElementById("fail1").value != null){
	alert("用户名或密码错误。");
}
</script>
</html>
